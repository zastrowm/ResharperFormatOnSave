...
namespace ReSharperFormatOnSave.Integration.Events
{
  /// <summary>
  ...
  internal class RunningDocumentTableEventListener : BaseEventListener, IVsRunningDocTableEvents3
  {
    ...
    public int OnAfterAttributeChangeEx(uint docCookie,
                                        uint grfAttribs,
    ...
    public int OnAfterFirstDocumentLock(uint docCookie,
                                        uint dwRDTLockType,
